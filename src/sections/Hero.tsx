...
export const HeroSection = () => {
  return <div className='py-32 md:by-48 lg:py-60 relative z-0 overflow-x-clip'>
    ...
    <div className="container">
      ...
      <div className='max-w-lg mx-auto'>
        ...
        <p className='mt-4 text-center text-white/60 md:text-lg'>I specialize in transforming designs into functional, high-performing web application. Let's discuss your next project.</p>
      </div>
